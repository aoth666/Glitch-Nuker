...
          ░  ░  ░      ░  ░         ░              ░ ░         ░ """)
    ...
    print(f"""                                  
                  ...
                  \033[38;2;255;0;180m║   \033[37mVersion: {version.parse(__VERSION__)}      \033[38;2;255;0;180m║   \033[37mDev: Kyoja ElRoMaNy \033[38;2;255;0;180m        ║\033[0m
    ...
    """)
    choose = input(Fore.LIGHTRED_EX+"choose:")
    if choose == '1':
        ...
        chan_name = input(Fore.LIGHTRED_EX+"Channel Name:  ")
        amt = int(input(Fore.LIGHTRED_EX+"Amount:  "))
        async with aiohttp.ClientSession() as session:
        ...
        web_name = "kyoja ElRoMaNy"
        web_msg = input(Fore.LIGHTRED_EX+"Webhook Content:  ")
        msg_amt = int(input(Fore.LIGHTRED_EX+"Amount of Messages:  "))
        ...
        role_name = input(Fore.LIGHTRED_EX+"Role Name:  ")
        amt = int(input(Fore.LIGHTRED_EX+"Amount:  "))
        async with aiohttp.ClientSession() as session:
